          ...
          <div class="q-pa-md agg">
            ...
            <q-table :rows="rows" :columns="columns">
              <template v-slot:body-cell-estado="props" style="opacity: 0">
                ...
                <td v-else style="color: red; text-align: center; font-weight: bold;">INACTIVO</td>
              </template>
                ...
                <q-input
                  ...
                  :rules="[
                    ...
                    (val) =>
                      ...
                      'El correo debe tener @gmail.com',
                  ]"
                />
                <q-input
                  dense
...
const listarUsuarios = async () => {
  rows.value = await users.getUsers();
  // console.log(rows.value[2]);
};
...
async function inactive(props) {
  ...
  let res = await users.inactiveUser(props._id);
  loading.value = false;
  listarUsuarios();
}
...
async function active(props) {
  ...
  let res = await users.activeUser(props._id);
  loading.value = false;
  listarUsuarios();
}
...
async function guardarEditarDatos() {
  if (bd.value == 0) {
    ...
    let res = await users.addUser(datos);
    listarUsuarios();
    nuevo.value = false;
    console.log(res);
    ...
    let res = await users.editUser(_id, datos);
    listarUsuarios();
    nuevo.value = false;
    console.log(res);
